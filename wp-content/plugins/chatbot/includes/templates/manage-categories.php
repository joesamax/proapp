...
<div class="qcwrap">
    <div class="wp-chatbot-wrap">
		...
		<div class="wpbot_addons_section container">
			...
			<a href="<?php echo add_query_arg( 'opt', 'add', admin_url('admin.php?page=simple-text-response&action=manage-category') ); ?>" class="page-title-action button">Add New Category</a>
