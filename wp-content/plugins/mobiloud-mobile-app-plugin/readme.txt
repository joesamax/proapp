...
Done-for-you service to publish iOS and Android native mobile apps for your WordPress site.

== Description ==
**[MobiLoud](https://www.mobiloud.com/?ref=plugindesc) helps you convert your WordPress site into a native mobile app for iOS and Android phones and tablets, published to App Store and Google Play for you. Turn your website into an app, send push notifications and connect directly to your users.**

From news sites to complex WordPress websites, MobiLoud has a solution to make building mobile apps easy and affordable:

Install the plugin to configure and manage your app and push notifications once you're a customer. If you're not a customer, [request a demo](https://www.mobiloud.com/demo/?ref=plugindesc).

Got any questions or need any help? Email us at [support@mobiloud.com](mailto:support@mobiloud.com).

**NOTE: If you're looking for a free tool to build a mobile app, this is not the right plugin. We're a service and this plugin is meant for MobiLoud customers.**

= What is MobiLoud? =

Watch the video to see what a MobiLoud app looks like.

[vimeo https://vimeo.com/358324321]
...
* **MobiLoud is a complete "Done-For-You" App Development service including a mobile app customization, build and submission service and premium support**. You don't need to learn any coding and do any of the work to get your mobile app published. Our mobile app developers will take care of all the build and publishing work for you.
* **MobiLoud apps are truly native apps**. Native apps ensure the best user experience for your readers
...
* **MobiLoud is designed for high traffic sites** and supports a number of mobile app specific advertising, analytics and membership solutions to give you all you need to monetize and grow traffic from your mobile app.
...
* **Mobile advertising and monetisation** -- Make more money from your mobile traffic. Use banner ads, interstitials and native ads designed specifically for mobile apps (Admob, Google DFP, AdX, Adsense and more supported).
...
= Why build a WordPress mobile app? =

MobiLoud lets you publish native, custom mobile apps that update automatically with your content, run fast on iOS and Android and offer offline support, native image galleries, sharing, mobile advertising, subscriptions and advanced push notifications.

You get all the benefits of your own native app, with none of the costs and headaches. Agencies regularly quote $50-100k for a mobile app, even a "simple" content app. With MobiLoud you get a custom app and a full service solution, at a fraction of the cost.

* Get a custom mobile app in weeks rather than months, all done for you
...
* Offer a better user experience to mobile users, leading to more time spent in your app, repeat visits and more traffic
...
Your mobile app is integrated with leading mobile app specific ad servers like AdMob and Facebook Audience Network, as well as Google Ad Manager, to give you maximum flexibility in serving your own inventory. If you don't have your own inventory, then you can easily monetize your app with banners from ad networks like AdMob, which is fully supported in your mobile app.

We support the following options:

* Google Ad Manager DFP ad servers supported, with support for banners, interstitials, and native ads.
* AdMob banners and interstitial (full screen) ads.
* Facebook Audience network banner, native ads and full screen ads
* HTML/Javascript/iframe ad units you can embed directly in your content
* We can integrate any advertising SDK or web banner units in your app

= Sell subscriptions and memberships =

With in-app purchase support, your own mobile app makes it easy to sell access to premium content, membership benefits or offer the option to remove ads with a subscription payment.

We can integrate any Paywall, membership plugin and create any combination of free, premium only or freemium offers.

You can offer users that already have an account with you the option to login to their existing account, as well as requiring a registration to access content.


= Launch your apps, the easy way =

We take care of configuring, customizing, building, testing and publishing your app for you, so you don't have to worry about any of the work required!

We publish the apps on your own App Store and Google Play account, or send you binaries you can publish yourself.
...
With MobiLoud both you and your users have full control over what notifications they receive, so you can limit push to timely updates that your users will value.
...
* Completely customizable. [Request a demo](https://www.mobiloud.com/demo/?ref=plugindesc) to learn how MobiLoud works and how we can customize it to your design and add all the functionality you need from your site.
* Unlimited automatic and manual push notifications to your mobile app users (compatible with posts and custom post types)
* Customizable mobile app menu with pages, categories, tags, custom taxonomies and links
...
* Advertising with mobile app specific ad solutions: AdMob, Facebook Audience Network, Adsense, MoPub, Google Ad Manager (DFP) or your own custom HTML ads
* Banner, interstitial and native ads supported in all of your mobile app's screens
* Sell subscriptions using in-app purchase to unlock premium content or remove ads
* Offline access to content already downloaded by the mobile app
* Support for Google Analytics and Firebase Analytics with complete mobile app usage statistics
...
* Create a members only, login protected mobile app with access to your user database
* Complete integrations with membership plugins, paywalls and other solutions to limit access to premium content
...
= All the advantages of a full service solution =

* We customize your app and we can integrate any functionality from your site
* A team of developers available to help
* Configuration, testing and submission to Apple App Store and Google Play all included (we do all the work for you)
...
We offer a service and as such we can't offer a trial or free preview. Your app will be built and customized for you. If for any reason you're not happy with the result you have 60 days to request a full refund.
...
[vimeo https://vimeo.com/354094380]

[vimeo https://vimeo.com/354094639]

[vimeo https://vimeo.com/332400724]

[Read more at MobiLoud.com](https://www.mobiloud.com/reviews/?ref=plugindesc)
...
= Who is MobiLoud for? =
MobiLoud is a native mobile app service specifically built for WordPress content publishers. It's the only effortless solution designed for news sites, blogs, content sites.
...
Yes, we handle the configuration, build and submission process for you. But you can also do it yourself if you want to. We can provide binary files for you to complete the submission work.

= How long will it take to publish my app? =
From your order to submitting the apps we take generally around 10 business days, including time for you to test it. If customizations are required, we might take a few weeks to get it ready. Note Apple then takes up to 5 business days to approve your app for the App Store. Publishing on Google Play requires just a few hours for the store to update.

= How does your money back guarantee work? =
With every plan and license we offer a 60-day Money Back Guarantee, meaning there's no risk for you, as we'll refund you completely within 60 days from your purchase if you're not happy with your app or our services.
