	...
	<div class="ml2-body">
		<div class='ml-col-row'>
			...
			<p>Read more in our <a
				href="https://www.mobiloud.com/help/knowledge-base/using-the-code-editor/<?php echo esc_url( get_option( 'affiliate_link', null ) ); ?>?utm_source=wp-plugin-admin&utm_medium=web&utm_campaign=editor"
			...
			<select id="preview_popup_post_select">
				...
				?>
						<optgroup label="<?php echo esc_attr( ucfirst( $post_type ) ); ?>">
							<?php foreach ( $posts as $post ) { ?>
								...
								<option
									value="<?php echo esc_attr( site_url( '/ml-api/v1/post/?post_id='. $post->ID ) ); ?>">
				...
				<optgroup label="Pages">
					<?php foreach ( $pages as $page ) { ?>
						...
						<option value="<?php echo esc_attr( site_url( '/ml-api/v1/post/?post_id='. $page->ID ) ); ?>">
