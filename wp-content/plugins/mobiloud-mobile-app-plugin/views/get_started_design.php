...
<div class="ml2-block">
	...
	<div class="ml2-body">
		...
		<div class="ml2-wide50-r">
			...
			?>
			<div class="get_started_preview shrinked <?php echo strlen( get_option( 'ml_preview_os' ) ) ? esc_attr( get_option( 'ml_preview_os' ) ) : 'ios'; ?>">
		...
		<div class="ml-form-row">
			<label>Device Rotation</label>
			<div class="ml-checkbox-wrap">
				<input type="checkbox" id="ml_allow_landscape" name="ml_allow_landscape"
					   value="true" <?php echo Mobiloud::get_option( 'ml_allow_landscape', true ) ? 'checked' : ''; ?>/>
				<label for="ml_allow_landscape">Allow device rotation to landscape mode</label>
			</div>
		</div>
		<div style='clear:both;'></div>
