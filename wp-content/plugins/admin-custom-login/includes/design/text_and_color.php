	...
	<div class="panel-body">
		<table class="form-table">
			...
			<tr class="radio-span" style="border-bottom:none;">
				<td>
					<span>
						<input type="radio" name="show_remember_me_field" value="yes" id="show_remember_me_field1" <?php if($show_remember_me_field=="yes")echo "checked"; ?> />&nbsp;<?php esc_html_e('Yes', WEBLIZAR_ACL)?><br>
					</span>
					<span>
						<input type="radio" name="show_remember_me_field" value="no" id="show_remember_me_field2" <?php if($show_remember_me_field=="no")echo "checked"; ?> />&nbsp;<?php esc_html_e('No', WEBLIZAR_ACL)?><br>
					</span>
				</td>
			</tr>
		</table>
	...
	<div class="panel-body">
		<table class="form-table">
			...
			<tr class="radio-span" style="border-bottom:none;">
				<td>
					<span>
						<input type="radio" name="show_back_to_site_link" value="yes" id="show_back_to_site_link1" <?php if($show_back_to_site_link=="yes")echo "checked"; ?> />&nbsp;<?php esc_html_e('Yes', WEBLIZAR_ACL)?><br>
					</span>
					<span>
						<input type="radio" name="show_back_to_site_link" value="no" id="show_back_to_site_link2" <?php if($show_back_to_site_link=="no")echo "checked"; ?> />&nbsp;<?php esc_html_e('No', WEBLIZAR_ACL)?><br>
					</span>
				</td>
			</tr>
		</table>
	...
	<div class="panel-body">
		<table class="form-table">
			...
			<tr class="radio-span" style="border-bottom:none;">
				<td>
					<span>
						<input type="radio" name="show_copyright_link_text" value="yes" id="show_copyright_link_text1" <?php if($show_copyright_link_text=="yes")echo "checked"; ?> />&nbsp;<?php esc_html_e('Yes', WEBLIZAR_ACL)?><br>
					</span>
					<span>
						<input type="radio" name="show_copyright_link_text" value="no" id="show_copyright_link_text2" <?php if($show_copyright_link_text=="no")echo "checked"; ?> />&nbsp;<?php esc_html_e('No', WEBLIZAR_ACL)?><br>
					</span>
				</td>
			</tr>
		</table>
