=== appful Mobile App Plugin – Create a iOS & Android mobile App with our WordPress App Builder ===
Contributors: appful, mobileappappful
Donate link: https://appful.io/
Tags: mobile app, mobile, app, ios, android, plugin, iphone, blog, ipad, apps, native, builder
...
**[appful](https://appful.io/ "Create mobile iPhone & iPad Apps")® is a SaaS company focused on enterprise software. Our mission is to help companies, publishers & magazines to reach their customers, employees & users with their content - through one of the most powerful content channel: mobile apps.**

[youtube https://www.youtube.com/watch?v=qix0SjXjb-M]
...
= appful Mobile App Plugin 1.0.88 =
* prepare for cdn

= appful Mobile App Plugin 1.0.78 =
* improved app push

= appful Mobile App Plugin 1.0.70 =
* fixed an issue with push notifications

= appful Mobile App Plugin 1.0.60 =
* adding support for crazy lazy plugin

= appful Mobile App Plugin 1.0.58 =
* improved commenting

= appful Mobile App Plugin 1.0.53 =
* introducing overlay banner

= appful Mobile App Plugin 1.0.52 =
* general improvements

= appful Mobile App Plugin 1.0.51 =
* added android deep linking

= appful Mobile App Plugin 1.0.46 =
* adding multi language support

= appful Mobile App Plugin 1.0.45 =
* better taxonomy sync

= appful Mobile App Plugin 1.0.44 =
* added universal links for android

= appful Mobile App Plugin 1.0.43 =
* added facebook deeplinking

= appful Mobile App Plugin 1.0.42 =
* added taxonomy images

= appful Mobile App Plugin 1.0.41 =
* fixing redirect bug

= appful Mobile App Plugin 1.0.40 =
* performance improvements

= appful Mobile App Plugin 1.0.39 =
* performance improvements

= appful Mobile App Plugin 1.0.38 =
* performance improvements

= appful Mobile App Plugin 1.0.37 =
* performance improvements

= appful Mobile App Plugin 1.0.36 =
* performance improvements

= appful Mobile App Plugin 1.0.36 =
* automatically import wordpress menu into your mobile app

= appful Mobile App Plugin 1.0.35 =
* performance improvements

= appful Mobile App Plugin 1.0.34 =
* added deeplinking
...
= appful Mobile App Plugin 1.0.30 =
* support for custom post types

= appful Mobile App Plugin 1.0.29 =
* compatibility update for php 5.2

= appful Mobile App Plugin 1.0.11 =
* app security improvements

= appful Mobile App Plugin 1.0.10 =
* fixed read more

= appful Mobile App Plugin 1.0.9 =
* custom post types

= appful Mobile App Plugin 1.0.6 =
* added author thumbnail

= appful Mobile App Plugin 1.0.4 =
* Multiple Server implementation

= appful Mobile App Plugin 1.0.3 =
* Enable/Disable Push-Notifications for each Post
* Fixed Slider-Checkbox

= appful Mobile App Plugin 1.0.2 =
* Bugfixes at mobile App

= appful Mobile App Plugin 1.0.1 =
* Added App Smart-Banner

= appful Mobile App Plugin 1.0 =
* Release
